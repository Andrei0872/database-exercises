/* 
Important: nu am folosit Oracle SQL, ci MySQL. Prin urmare, unele features nu au fost disponibile,
cum ar fi: OUTER JOIN, MINUS.

Am folosit o baza de date locala, iar fisierul `interviu.sql` adaptat pentru MySQL poate fi gasit aici: https://github.com/Andrei0872/database-exercises/blob/tema-1-laborator/sql/interviu.sql
De asemenea, daca aveti `docker-compose` instalat, va puteti folosi de `docker-compose.yml`-ul din repo-ul aferent temei 1: https://github.com/Andrei0872/database-exercises/tree/tema-1-laborator.
*/
